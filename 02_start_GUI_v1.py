...
class Start:
    def __init__(self, parent):
        ...
        # Mystery heading (row 0)
        self.mystery_instructions = Label(self.start_frame, text="Please enter a dollar amount (between $5 and $50) in the box below. Then choose the stakes. The higher the stakes, the more you can win!\n", font="Arial 10 italic", justify=LEFT, padx=10, pady=10, wrap=250)
        self.mystery_instructions.grid(row=1)

        self.amount_error_label = Label(self.start_frame)
        # Entry box (row 1)
